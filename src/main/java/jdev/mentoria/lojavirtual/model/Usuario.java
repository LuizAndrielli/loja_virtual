...
public class Usuario implements UserDetails {
	...
	value = ConstraintMode.CONSTRAINT)),inverseJoinColumns = @JoinColumn(name="usuario_fk",unique = false, referencedColumnName = "id",table = "acesso",
	foreignKey = @ForeignKey(name="acesso_id",value = ConstraintMode.CONSTRAINT)))
